...
static void led_color_changed(VariableItem* item) {
    ...
    notification_message_apply_led_color(app->notification); /* live preview */
...
static void led_timeout_changed(VariableItem* item) {
    ...
    notification_message_apply_led_color(app->notification); /* re-arms timer with new value */
    notification_message_save_settings(app->notification); /* persist */
}
...
static void led_speed_changed(VariableItem* item) {
    ...
    notification_message_apply_led_color(app->notification); /* restart effect at new speed */
    notification_message_save_settings(app->notification); /* persist */
}
// --- LED COLOR END ---
