...
static void jammer_radio_device_loader_power_on() {
    uint8_t attempts = 0;
...
static void jammer_radio_device_loader_power_off() {
...
const SubGhzDevice* jammer_radio_device_loader_set(
    ...
    if(radio_device_type == SubGhzJammerRadioDeviceTypeExternalCC1101 &&
